 ...
 */
package de.marx_labs.utilities.common.searchtree.test;

import de.marx_labs.utilities.common.searchtree.MapSearchTree;
import de.marx_labs.utilities.common.searchtree.SearchTree;
import java.util.List;
import java.util.Set;

public class SearchTreeTest {
	public static void main (String [] args) throws Exception {
		SearchTree<String> tree = new MapSearchTree<String>(10);
...
//		Set<String> result = tree.newest(3);
//		printResult(result);
//		result = tree.findOld(8L, 3);
//		printResult(result);
		
//		List<String> result = tree.findNew(0L, 3);
//		printResult(result);
//		
//		System.out.println("\nnext\n");
...
//		result = tree.findNew(35314053391851520L, 3);
//		printResult(result);
	}
