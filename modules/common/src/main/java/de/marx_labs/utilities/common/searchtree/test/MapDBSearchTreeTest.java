...
import de.marx_labs.utilities.common.searchtree.MapDBSearchTree;
import java.util.List;
import java.util.Set;

public class MapDBSearchTreeTest {
	public static void main (String [] args) throws Exception {
		MapDBSearchTree<String> tree = new MapDBSearchTree<String>(10);
